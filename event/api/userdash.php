...
<body>
        ...
        <div class="review-slider swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    ...
                    <p>I and my family are incredibly happy with how the things turned out at the occasion of my marriage. Our trust in V3 Events & Weddings turned not only worthy but incredible! The ambiance of the night that was created by all of the little
                        touches, like the musicthe hostsand the waiters were just so special..</p>
                </div>
                ...
                <div class="swiper-slide box">
                    ...
                    <p>Having availed services from V3 Events & Weddings recently, I admire the way they executed the event putting their expertise of Event Management skills. I would not hesitate to recommend them to work with any corporate company, organization
                        or charity in the delivery of their event.</p>
                </div>
                ...
                <div class="swiper-slide box">
                    ...
                    <p>I wanted to drop you a line to say thank you for a FANTASTIC event. We’re thrilled with the day and everyone is talking about it today. It was a great result for us and we appreciate all your hard work and effort , all your team were
                        so awesome they all give their full effort, thanku you so much.</p>
                </div>
                ...
                <div class="swiper-slide box">
                    ...
                    <p>I want to thank you for your positive attitude and absolute commitment to making any event here at Delhi a “WOW” experience for our people.your all teams are so skillfull everyone were very polite and decent , i just loved your event
                        that was amazing, thank you so much.</p>
                </div>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="#"> <i class="fas fa-phone"></i> +91-8178513451 </a>
                <a href="#"> <i class="fas fa-phone"></i> +91-8383942509 </a>
                <a href="#"> <i class="fas fa-envelope"></i> manishkumar18853@gmail.com </a>
                <a href="#"> <i class="fas fa-envelope"></i> abhishekkumar44048@gmail.com </a>
                <a href="#"> <i class="fas fa-map-marker-alt"></i> ballabhgarh,faridabad- 121004 </a>
            </div>
        ...
        <div class="credit"> created by <span>Abhishek & Manish </span> | all rights reserved </div>
